...
$sql = "   SELECT 'us' AS org, " . calculateTopSeats (            "'us', 'us-sen', 'us-hou'") . ", "
     ...
     . "UNION "
     . "   SELECT 'mi' AS org, " . calculateTopSeats(             "'mi', 'mi-sos', 'mi-ag', 'crt-sup', 'mi-prop'") . ", "
     .                             calculateTopMetric("reviewed", "'mi', 'mi-sos', 'mi-ag', 'crt-sup', 'mi-prop'") . " AS rcount, "
     .                             calculateTopMetric("endorsed", "'mi', 'mi-sos', 'mi-ag', 'crt-sup', 'mi-prop'") . " AS ecount "
     . "UNION "
