      ...
      <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}');"
         ...
         <ul id="C{$county.cnty[1]}" style="display: none;">
            ...
            <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}Y');"
                   ...
                   {if $county.city_num == $county.city_den  and  $county.city_den > 0} <img src="green-check.png" width="12"/> {/if}
            ...
            <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}P');"
                ...
                {if $county.town_num == $county.town_den  &&  $county.town_den > 0} <img src="green-check.png" width="12"/> {/if}
             ...
             {if $county.vil|count > 0 }
               <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}V');"
                     ...
                     {if $county.vil_num == $county.vil_den  and  $county.vil_den > 0} <img src="green-check.png" width="12"/> {/if}
            ...
            <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}S');"
                   ...
                   {if $county.schl_num == $county.schl_den  and  $county.schl_den > 0} <img src="green-check.png" width="12"/> {/if}
         ...
         <!--
            <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}C');"
                 ...
                 {if $county.col_num == $county.col_den  and  $county.col_den > 0} <img src="green-check.png" width="12"/> {/if}
         ...
         -->
            ...
            <li><a href='#' class="parent" onClick="return flipArrow('{$county.cnty[1]}T');"
               ...
               {if $county.crt_num == $county.crt_den  and  $county.crt_den > 0} <img src="green-check.png" width="12"/> {/if}
